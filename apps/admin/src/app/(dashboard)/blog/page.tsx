  ...
  return (
    <RequirePermission permission={Permission.SeoRead}>
      <div className="space-y-6">
        <PageHeader
          title="Blog CMS"
          description="Manage articles, categories, tags, publishing, Markdown, cover images, and SEO."
        />
        ...
        <section className="overflow-hidden rounded-lg border bg-card shadow-sm">
          ...
          {isLoading ? (
            <p className="p-6 text-sm text-muted-foreground">Loading blog content...</p>
          ) : null}
...
function TaxonomyPanel<T extends { id: string; name: string; slug: string }>({
  title,
  value,
  onChange,
  onAdd,
