...
export function ToolLogo({
  ...
  const showFallbackLogo = !showPrimaryLogo && Boolean(fallbackLogoUrl) && !fallbackLogoFailed;
  const showGeneratedAvatar = !showPrimaryLogo && !showFallbackLogo && initials.length > 0;
  ...
  return (
    ...
    >
      ...
      {!showPrimaryLogo && !showFallbackLogo && !showGeneratedAvatar && !showCategoryIcon ? (
